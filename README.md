# utl-a-better-proc-r-using-altair-slc-a-sandwich-interface-with-any-app-that-supports-a-cli
A better proc r using altair slc a sandwich interface with any app that supports a cli
    ...
    github
    This is a additional less flexible implementation then the previous macro wrapper solution.
    https://github.com/rogerjdeangelis/utl-a-better-proc-r-using-altair-slc-a-sandwich-interface-with-any-app-that-supports-a-cli


    previous more flexible solution
    github
